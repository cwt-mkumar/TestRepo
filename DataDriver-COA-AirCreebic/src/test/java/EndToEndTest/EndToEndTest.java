...
public class EndToEndTest extends TestBase {
	...
	public void EndToEndTest() {
		...
		try {
			...
			test = extent.createTest("TA-1 - Make a search for 1Adult1Room");
			openBrowser("Chrome");
			...
			LOGGER.info("Exception in endToEndTest1");
		}
	}
	
	
	@Test(testName = "TC002", priority=2)
	public void EndToEndTest2() {
		...
		try {
			PageObjectManager pageObjectManager = new PageObjectManager();
			test = extent.createTest("TA-2 - Make a search for 2Adult2Room");
			openBrowser("Chrome");
			navigateTo_HomePage(envVariablesMap.get("URL"));
			pageObjectManager.getHotelSearchPage().ClickHotelLink();
			pageObjectManager.getHotelSearchPage().SelectDestination();
			...
			LOGGER.info("Exception in endToEndTest2");
		}
	}
